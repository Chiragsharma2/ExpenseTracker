...
const LoginPrompt = ({ toggleView }) => (
    <div className="p-8 h-full flex flex-col justify-center items-center text-white">
        ...
        <p className="mb-4 text-center">Already a member of CashCompass? Log in now with your credentials to access your account and manage your finances.</p>
...
const RegisterPrompt = ({ toggleView }) => (
    <div className="p-8 h-full flex flex-col justify-center items-center text-white">
        ...
        <p className="mb-4 text-center">New to CashCompass? Sign up now to unlock powerful features, personalized insights, and secure expense tracking. Join us and take the first step towards financial freedom!</p>
